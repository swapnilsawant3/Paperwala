...
{
    public class SellerMasterController : Controller
    {
        IStateMaster objstate;
        ICityMaster objcity;
        ISellerMaster objseller;

        public SellerMasterController()
        {
            objstate = new StateMaster();
            objcity = new CityMaster();
            objseller = new SellerMaster();
        }
        [HttpGet]
        public ActionResult Details()
        {
            return View(objseller.GetSellers());
        }
        ...
        public ActionResult Edit(string id)
        {
            ...
            var model = objseller.GetSellerByID(id);
        ...
        public JsonResult GetPassword(string SellerId)
        {
            var DPassword = objseller.GetPassword(SellerId);
