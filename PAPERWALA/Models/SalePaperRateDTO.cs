...
{
    [Table("Mst_SalePaperRate")]
    public class SalePaperRateDTO
    {
        [Key]
        public int SalePaperRateId { get; set; }

        [Display(Name = "Paper Name")]
        [Validate_SalePaperRate(ErrorMessage = "Select Paper")]
        public int? PaperId { get; set; }
        [Display(Name = "Paper Name")]
        public string PaperName { get; set; }

        [Display(Name = "City Name")]
        [Validate_SalePaperRate(ErrorMessage = "Select City")]
        public int? CityId { get; set; }
        [Display(Name = "City Name")]
        public string CityName { get; set; }

        [Display(Name = "State Name")]
        [Validate_SalePaperRate(ErrorMessage = "Select Sate")]
    ...
    public class Validate_SalePaperRate : ValidationAttribute
    {
